...
```
El estadístico de prueba es la linea azul y el z critico es la linea roja. No rechazamos la hipótesis nula de que la media poblacional es menor o igual a 40 ppm
```{r, echo=FALSE}
z <- qnorm(0.95)
Zcritico <- (Media_Muestral-u)/(Desviacion_Estandar_Muestral/sqrt(n))
...
El estadístico de prueba es la linea azul y el z critico es la linea roja. No rechazamos la hipótesis nula de que la media poblacional es menor o igual a 3500 ppm. Para este caso la media poblacional es mucho mas grande que la media muestral por lo que se le un estadistco de prueba de -197.27. 
```{r, echo=FALSE}
z <- qnorm(0.95)
Zcritico <- (Media_Muestral-u)/(Desviacion_Estandar_Muestral/sqrt(n))
N<- c("Estadistico de prueba","Z critico")
...
El estadístico de prueba es la linea azul y el z critico es la linea roja. Rechazamos la hipótesis nula de que la media poblacional es menor o igual a 3 ppm. Para este caso nuestra media muestral es mas grande la la media poblacional.
```{r, echo=FALSE}
z <- qnorm(0.95)
Zcritico <- (Media_Muestral-u)/(Desviacion_Estandar_Muestral/sqrt(n))
N<- c("Estadistico de prueba","Z critico")
...
El estadístico de prueba es la linea azul y el z critico es la linea roja. No rechazamos la hipótesis nula de que la media poblacional es menor o igual a 100 ppm. 
```{r, echo =FALSE}
z <- qnorm(0.95)
Zcritico <- (Media_Muestral-u)/(Desviacion_Estandar_Muestral/sqrt(n))
N<- c("Estadistico de prueba","Z critico")
...
El estadístico de prueba es la linea azul y el z critico es la linea roja. No rechazamos la hipótesis nula de que la media poblacional es menor o igual a 1.749  ppm. 
```{r, echo=FALSE}
z <- qnorm(0.95)
Zcritico <- (Media_Muestral-u)/(Desviacion_Estandar_Muestral/sqrt(n))
N<- c("Estadistico de prueba","Z critico")
...
```
El estadístico de prueba es la linea azul y el z critico es la linea roja. Rechazamos la hipótesis nula de que la media poblacional es menor o igual a 140 ppm. 
```{r, echo=FALSE}
z <- qnorm(0.95)
Zcritico <- (Media_Muestral-u)/(Desviacion_Estandar_Muestral/sqrt(n))
N<- c("Estadistico de prueba","Z critico")
...
El estadístico de prueba es la linea azul y el z critico es la linea roja. No rechazamos la hipótesis nula de que la media poblacional es menor o igual a 277 ppm. 
```{r, echo=FALSE}
z <- qnorm(0.95)
Zcritico <- (Media_Muestral-u)/(Desviacion_Estandar_Muestral/sqrt(n))
N<- c("Estadistico de prueba","Z critico")
...
El estadístico de prueba es la linea azul y el z critico es la linea roja. No rechazamos la hipótesis nula de que la media poblacional es menor o igual a 91 ppm. Para este caso nuestra media muestral es mas grande la la media poblacional.
```{r, echo=FALSE}
z <- qnorm(0.95)
Zcritico <- (Media_Muestral-u)/(Desviacion_Estandar_Muestral/sqrt(n))
N<- c("Estadistico de prueba","Z critico")
