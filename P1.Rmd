...
## Objetivo
En este trabajo analizaremos la base de datos de los componentes de suelo tomado aleatoreamente. Con ello se podria determinar si existen suelos contaminados.
...
Para la base de datos del suelo se usaran los componentes como variables ya que nos permitiran determinar si son  suelos contaminados o no. Las unidades de medida son partes por millon (ppm)
...
La razon de porque elegimos analizar los suelos es porque del 2019 al 2020 se presentaron diferentes denucnas por diferente sector donde la mayor cantidad de denuncias era la del suelo
...
Una muestra de 227 con un nivel de confianza del 95%. La hipotesis nula es que la media poblacional es menor o igual a 40ppm . Al ser una muestra mayor a 30 trabajaremos con qnorm.
Datos:
n=227,
...
```
El estadístico de prueba es la linea azul y el z critico es la linea roja. No rechazamos la hipotesis nula de que la media poblacional es menor o igual a 40 ppm
```{r}
z <- qnorm(0.95)
Zcritico <- (Media_Muestral-u)/(Desviacion_Estandar_Muestral/sqrt(n))
...
Una muestra de 227 con un nivel de confianza del 95%. La hipotesis nula es que la media es menor o igual a 3500. Al ser una muestra mayor a 30 trabajaremos con qnorm.
Datos:
n=227
intercalo de confianza del 95%
nivel de significancia del 5%
...
El estadístico de prueba es la linea azul y el z critico es la linea roja. No rechazamos la hipotesis nula de que la media poblacional es menor o igual a 3500 ppm. Para este caso la media poblacional es mucho mas grande que la media muestral por lo que se le un estadistco de prueba de -197.27. 
```{r}
z <- qnorm(0.95)
Zcritico <- (Media_Muestral-u)/(Desviacion_Estandar_Muestral/sqrt(n))
N<- c("Estadistico de prueba","Z critico")
...
Una muestra de 227 con un nivel de confianza del 95%. La hipotesis nula es que la media es menor o igual a 3. Al ser una muestra mayor a 30 trabajaremos con qnorm.
Datos:
n=227
intercalo de confianza del 95%
...
El estadístico de prueba es la linea azul y el z critico es la linea roja. Rechazamos la hipotesis nula de que la media poblacional es menor o igual a 3 ppm. Para este caso nuestra media muestral es mas grande la la media poblacional.
```{r}
z <- qnorm(0.95)
Zcritico <- (Media_Muestral-u)/(Desviacion_Estandar_Muestral/sqrt(n))
N<- c("Estadistico de prueba","Z critico")
...
En las muestras solo se encontraron 14 suelos que prensentaron Cianuro libre.
```{r, echo=FALSE}
...
Una muestra de 227 con un nivel de confianza del 95%. La hipotesis nula es que la media menor o igual a 100. Al ser una muestra mayor a 30 trabajaremos con qnorm.
Datos:
n=227
intercalo de confianza del 95%
nivel de significancia del 5%
...
El estadístico de prueba es la linea azul y el z critico es la linea roja. No rechazamos la hipotesis nula de que la media poblacional es menor o igual a 100 ppm. 
```{r}
z <- qnorm(0.95)
Zcritico <- (Media_Muestral-u)/(Desviacion_Estandar_Muestral/sqrt(n))
N<- c("Estadistico de prueba","Z critico")
...
Una muestra de 227 con un nivel de confianza del 95%. La hipotesis nula es que la media es menor o igual a 1.749. Al ser una muestra mayor a 30 trabajaremos con qnorm.
Datos:
n=227
intercalo de confianza del 95%
nivel de significancia del 5%
...
El estadistico de prueba es la linea azul y el z critico es la linea roja. No rechazamos la hipotesis nula de que la media poblacional es menor o igual a 1.749  ppm. 
```{r}
z <- qnorm(0.95)
Zcritico <- (Media_Muestral-u)/(Desviacion_Estandar_Muestral/sqrt(n))
N<- c("Estadistico de prueba","Z critico")
...
Una muestra de 227 con un nivel de confianza del 75%. La hipotesis nula es que la media es menor o igual a 140. Al ser una muestra mayor a 30 trabajaremos con qnorm.
Datos:
n=227
intercalo de confianza del 95%
nivel de significancia del 5%
...
```
El estadistico de prueba es la linea azul y el z critico es la linea roja. Rechazamos la hipotesis nula de que la media poblacional es menor o igual a 140 ppm. 
```{r}
z <- qnorm(0.95)
Zcritico <- (Media_Muestral-u)/(Desviacion_Estandar_Muestral/sqrt(n))
N<- c("Estadistico de prueba","Z critico")
...
Una muestra de 227 con un nivel de confianza del 75%. La hipotesis nula es que la media es menor o igual a 277. Al ser una muestra mayor a 30 trabajaremos con qnorm.
Datos:
n=227
intercalo de confianza del 95%
nivel de significancia del 5%
...
El estadistico de prueba es la linea azul y el z critico es la linea roja. No rechazamos la hipotesis nula de que la media poblacional es menor o igual a 277 ppm. 
```{r}
z <- qnorm(0.95)
Zcritico <- (Media_Muestral-u)/(Desviacion_Estandar_Muestral/sqrt(n))
N<- c("Estadistico de prueba","Z critico")
...
Tab
```
Una muestra de 227 con un nivel de confianza del 75%. La hipotesis nula es que la media es menor o igual a 91. Al ser una muestra mayor a 30 trabajaremos con qnorm.
Datos:
n=227
intercalo de confianza del 95%
nivel de significancia del 5%
...
El estadistico de prueba es la linea azul y el z critico es la linea roja. No rechazamos la hipotesis nula de que la media poblacional es menor o igual a 91 ppm. Para este caso nuestra media muestral es mas grande la la media poblacional.
```{r}
z <- qnorm(0.95)
Zcritico <- (Media_Muestral-u)/(Desviacion_Estandar_Muestral/sqrt(n))
N<- c("Estadistico de prueba","Z critico")
...
Una muestra de 227 con un nivel de confianza del 95%. La hipotesis nula es que la media es igual a 23.26. Al ser una muestra mayor a 30 trabajaremos con qnorm.
Datos:
n=227
intercalo de confianza del 95%
nivel de significancia del 5%
...
```
El estadistico de prueba es la linea azul y el z critico es la linea roja. No rechazamos la hipotesis nula de que la media poblacional es menor o igual a 64 ppm. 
```{r}
z <- qnorm(0.95)
Zcritico <- (Media_Muestral-u)/(Desviacion_Estandar_Muestral/sqrt(n))
N<- c("Estadistico de prueba","Z critico")
...
### Conclusiones generales
 En nuestras gráficas de diagrama de caja varios elementos contaminantes presentan valores atípicos pero no todos significan suelos contaminantes. Para las hipotesis nulas muchas no se rechazan pero el estadístico de prueba es muy grande, puede ser generado por una media poblacional muy grande. Para corregirlo necesitaremos una muestra mas grande para precisar nuestros resultados.
...
```{r, echo=FALSE}
l1<- lm(CAS$Bario~CAS$Plomo)
cor(CAS$Bario,CAS$Plomo)
plot(CAS$Plomo,CAS$Bario,pch=20, col=rgb(0,0,0,0.3),xlim=c(0,1300), xlab="Plomo (ppm)", ylab="Bario (ppm)")
abline(l1, col="red")
```
...
Para la regresión lineal tenemos correlaciones positivas débiles (0-0.5) 
