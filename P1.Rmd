...
Utilizaremos graficas de diagrma de caja para ver los valores atipicos y de distribucion normal para rechazar o no la hipotesis nula.
...
Una muestra de 227 con un intervalo de confianza del 95%. La hipotesis nula es que la media poblacional es menor o igual a 40ppm . Al ser una muestra mayor a 30 trabajaremos con qnorm.
Datos:
n=227,
...
```
El estadistico de prueba es la linea azul y el z critico es la linea roja. No rechazamos la hipotesis nula que la la meida poblacional es menor o igual a 40 ppm
```{r}
z <- qnorm(0.95)
Zcritico <- (Media_Muestral-u)/(Desviacion_Estandar_Muestral/sqrt(n))
...
El estadistico de prueba es la linea azul y el z critico es la linea roja
```{r}
z <- qnorm(0.95)
Zcritico <- (Media_Muestral-u)/(Desviacion_Estandar_Muestral/sqrt(n))
N<- c("Estadistico de prueba","Z critico")
...
### Regresion lineal
Para la regresion lineal buscamos encontrar una posible relacion entre los elementos 

```{r, echo=FALSE}
l1<- lm(CAS$Mercurio~CAS$Plomo)
cor(CAS$Mercurio,CAS$Plomo)
plot(CAS$Plomo,CAS$Mercurio,pch=20, col=rgb(0,0,0,0.3),xlim=c(0,1300), xlab="Plomo (ppm)", ylab="Mercurio (ppm)")
abline(l1, col="red")
```
...
plot(CAS$Bario,CAS$Mercurio,pch=20, col=rgb(0,0,0,0.3),xlim=c(0,1300),xlab="Bario (ppm)", ylab="Mercurio (ppm)")
abline(l1, col="red")
```
...
plot(CAS$Cadmio,CAS$Mercurio,pch=20, col=rgb(0,0,0,0.3),xlim=c(0,10300),xlab="Cadmio (ppm)", ylab="Mercurio (ppm)")
abline(l1, col="red")
...
plot(CAS$Cobalto,CAS$Mercurio,pch=20, col=rgb(0,0,0,0.3),xlim=c(0,1300),xlab="Cobalto (ppm)", ylab="Mercurio (ppm)")
abline(l1, col="red")
