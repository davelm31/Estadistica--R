...
```{r,echo=FALSE}
#DEnuncias 2019-2020
ACTECO1920 <- c("INFRAESTRUCTURA","AGRICULTURA","INDUSTRIA", "MINERIA","COMERCIO", "SANEAMIENTO","HIDROCARBUROS","TRANSPORTE","GANADERIA","PESQUERIA","FORESTAL","CONSTRUCCION","ELECTRICIDAD","TELECOMUNICACIONES","TURISMO" )
CAN1920 <- c(sum(DD1920$`ACTIVIDAD ECONOMICA` == "INFRAESTRUCTURA"),sum(DD1920$`ACTIVIDAD ECONOMICA` == "AGRICULTURA"),sum(DD1920$`ACTIVIDAD ECONOMICA` == "INDUSTRIA"),sum(DD1920$`ACTIVIDAD ECONOMICA` == "MINERIA"),sum(DD1920$`ACTIVIDAD ECONOMICA`== "COMERCIO"),sum(DD1920$`ACTIVIDAD ECONOMICA` == "SANEAMIENTO"),sum(DD1920$`ACTIVIDAD ECONOMICA`== "HIDROCARBUROS"),sum(DD1920$`ACTIVIDAD ECONOMICA` == "TRANSPORTE"),sum(DD1920$`ACTIVIDAD ECONOMICA` == "GANADERIA"),sum(DD1920$`ACTIVIDAD ECONOMICA` == "PESQUERIA"),sum(DD1920$`ACTIVIDAD ECONOMICA`== "FORESTAL"),sum(DD1920$`ACTIVIDAD ECONOMICA` == "CONSTRUCCION"),sum(DD1920$`ACTIVIDAD ECONOMICA` == "ELECTRICIDAD"),sum(DD1920$`ACTIVIDAD ECONOMICA` == "TELECOMUNICACIONES"),sum(DD1920$`ACTIVIDAD ECONOMICA` == "TURISMO"))
