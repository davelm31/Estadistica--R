...
```{r}
estado_19 <- c("Cerrado", "En Seguimiento")
cantidad_d_19 <- c(sum(DD1920$ESTADO == "CERRADA"),sum(DD1920$ESTADO == "EN SEGUIMIENTO"))
color <- c("green", "red")
DDS_19<-data.frame(estado_19, cantidad_d_19)
barplot(DDS_19[1:3,2], legend = c("CERRADO", "EN SEGUIMIENTO"), col = color, xlab = "Estado de la denuncia", ylab = "Cantidad")
```
